 ...
 */
@Controller
public class NOControllersProd {
    ...
    private final static Logger LOG = LoggerFactory.getLogger(NOControllersProd.class);
    ...
    final static String NO_REDIRECT_URL_PROD = "NO_REDIRECT_URL_PROD";
    final static String NO_CLIENT_ID_PROD = "NO_CLIENT_ID_PROD";
    final static String NO_CLIENT_SECRET_PROD = "NO_CLIENT_SECRET_PROD";
    final static String NO_TOKEN_URL_PROD = "NO_TOKEN_URL_PROD";
    final static String NO_AUTH_URL_PROD = "NO_AUTH_URL_PROD";
    final static String NO_USER_INFO_URL_PROD = "NO_USER_INFO_URL_PROD";

    @Autowired
    public NOControllersProd(KeyStoreService keyServ) throws KeyStoreException, NoSuchAlgorithmException, UnrecoverableKeyException, UnsupportedEncodingException, InvalidKeySpecException, IOException {
    ...
    @RequestMapping(value = "/no/prod/idp/authenticate", method = {RequestMethod.POST, RequestMethod.GET})
    public ModelAndView authenticate(HttpServletRequest request, RedirectAttributes redirectAttrs, Model model,
        ...
        String noReturnUrl = paramServ.getParam(NO_REDIRECT_URL_PROD);
        String noClientId = paramServ.getParam(NO_CLIENT_ID_PROD);
        String noAuthURLProd = paramServ.getParam(NO_AUTH_URL_PROD);
...
//            String sessionId = (String) model.asMap().get("esmoSessionId");
    ...
    @RequestMapping(value = "/no/prod/idp/oidc", method = {RequestMethod.POST, RequestMethod.GET})
    public String getNorweigianEidasResponse(
        ...
        if (StringUtils.isEmpty(error)) {
            try {
                ...
                map.add("code", code);
                map.add("redirect_uri", paramServ.getParam(NO_REDIRECT_URL_PROD));
                map.add("client_id", paramServ.getParam(NO_CLIENT_ID_PROD));
                map.add("client_secret", paramServ.getParam(NO_CLIENT_SECRET_PROD));
                ...
                ResponseEntity<LinkedInAuthAccessToken> accessTokenResponse = restTemplate
                        .exchange(paramServ.getParam(NO_TOKEN_URL_PROD), HttpMethod.POST, request, LinkedInAuthAccessToken.class);
                ...
                ResponseEntity<String> userResponse
                        = restTemplate.exchange(this.paramServ.getParam(NO_USER_INFO_URL_PROD),
