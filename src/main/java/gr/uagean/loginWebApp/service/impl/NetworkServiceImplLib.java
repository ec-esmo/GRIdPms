 ...
 */
@Service
public class NetworkServiceImplLib implements NetworkServiceOld {
...
//
//    @Autowired
//    public NetworkServiceImpl(HttpSignatureServiceOld sigServ) {
...
//
//    @Override
//    public SessionMngrResponse sendPostForm(String hostUrl, String uri,
...
//
//    @Override
//    public SessionMngrResponse sendGet(String hostUrl, String uri,
//            List<NameValuePair> urlParameters) throws IOException, NoSuchAlgorithmException {
//
//        Date date = new Date();
//        SimpleDateFormat formatter = new SimpleDateFormat("EEE, d MMM YYYY HH:mm:ss z");
...
//
//    @Override
//    public String sendPostFormStringResponse(String hostUrl, String uri,
//            List<NameValuePair> urlParameters) throws IOException, NoSuchAlgorithmException {
//        Map<String, String> map = new HashMap();
//        MultiValueMap<String, String> multiMap = new LinkedMultiValueMap<>();
//        urlParameters.stream().forEach(nameVal -> {
...
//        String host = hostUrl.replace("http://", "").replace("https://", "");
//        try {
//            headers.add("authorization", sigServ.generateSignature(host, "POST", uri, map, "application/x-www-form-urlencoded", requestId));
//            Date date = new Date();
//            byte[] digestBytes;
//            //only when the request is json encoded are the post params added to the body of the request
//            // else they eventually become encoded to the url
...
//
//    @Override
//    public String sendGetStringResponse(String hostUrl, String uri,
//            List<NameValuePair> urlParameters) throws IOException, NoSuchAlgorithmException {
//        String requestId = UUID.randomUUID().toString();
//        UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(hostUrl + uri);
//        Map<String, String> map = new HashMap();
...
//        String host = hostUrl.replace("http://", "").replace("https://", "");
//        try {
//            headers.add("authorization", sigServ.generateSignature(host, "GET", uri, map, "application/x-www-form-urlencoded", requestId));
//            Date date = new Date();
//            byte[] digestBytes;
//            //only when the request is json encoded are the post params added to the body of the request
//            // else they eventually become encoded to the url
